                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6  text-left">
                                <a href="{{ route('barang.create') }}" class="btn btn-md btn-success">TAMBAH
                                    BARANG</a>
                            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                    ...
                                    <a href="{{ route('barang.show', $rowbarang->id) }}" class="btn btn-sm btn-dark"><i
                                            class="fa fa-eye"></i></a>
                                    <a href="{{ route('barang.edit', $rowbarang->id) }}" class="btn btn-sm btn-primary"><i
