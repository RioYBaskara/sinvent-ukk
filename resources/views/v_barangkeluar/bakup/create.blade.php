                ...
                <div class="card">
                    ...
                    <form action="{{ route('barangkeluar.store') }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror" name="tgl_keluar" value="{{ old('tgl_masuk') }}" placeholder="Masukkan tgl_masuk">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nis') is-invalid @enderror" name="qty_keluar" value="{{ old('nis') }}" placeholder="Masukkan Seri">
