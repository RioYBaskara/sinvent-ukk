                ...
                <div class="card-body">
                    <form action="{{ route('barangkeluar.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="date" class="form-control @error('tgl_masuk') is-invalid @enderror"
                                name="tgl_keluar" value="{{ old('tgl_masuk') }}" placeholder="Masukkan tgl_masuk">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('qty_keluar') is-invalid @enderror"
                                name="qty_keluar" value="{{ old('qty_keluar') }}" placeholder="Masukkan Jumlah Barang">
